def number_to_words(n):
    ...
    if n < 10:
        ...
        return number3[n - 10]
    elif n >= 10 and n < 100 and d.is_integer() and number2[int(d)] in number2:
    ...
    elif n >= 110 and n < 200 and n1 == 0 and number4[int(d1)] in number4:
    ...
    elif n >= 210 and n < 300 and n1 == 0 and number4[int(d1)] in number4:
        return  number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 220 < n < 300:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 300 < n < 310:
    ...
    elif n >= 310 and n < 400 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 320 < n < 400:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 400 < n < 410:
    ...
    elif n >= 410 and n < 500 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 420 < n < 500:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 500 < n < 510:
    ...
    elif n >= 510 and n < 600 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 520 < n < 600:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 600 < n < 610:
    ...
    elif n >= 610 and n < 700 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 620 < n < 700:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 700 < n < 710:
        ...
        return number4[int(d1)] + ' ' + number3[n - 710]
    elif n >= 710 and n < 800 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 720 < n < 800:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 800 < n < 810:
    ...
    elif n >= 810 and n < 900 and n1 == 0 and number4[int(d1)] in number4:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 820 < n < 900:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
    elif 900 < n < 910:
    ...
    elif n >= 910 and n < 1000 and n1 == 0 and number4[int(d1)] in number4:
        return  number4[int(d1)] + ' ' + number2[int(n3 / 10)]
    elif 920 < n < 1000:
        return number4[int(d1)] + ' ' + number2[int(n3 / 10)] + ' ' + number1[n1]
